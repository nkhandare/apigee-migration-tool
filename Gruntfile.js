...
module.exports = function(grunt) {
 ...
 require('time-grunt')(grunt);
  ...
  grunt.registerTask('importAll', ['importTargetServers', 'importProxies', 'importProxiesToX', 'importProducts', 'importDevs', 'importApps', 'importSharedFlows','importFlowHooks', 'importOrgKVM', 'importEnvKVM', 'importProxyKVM', 'importKeys', 'importReports']);
